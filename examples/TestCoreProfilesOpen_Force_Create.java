...
class TestCoreProfilesOpen_Force_Create {
    public static void main(String args[]) {
        ...
        System.out.println(" ===============================================================================================");
        System.out.println(" pulse 13, run 1 is written by a Java code (put) in the user current directory using an URI string");
