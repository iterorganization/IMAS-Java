...
//---------- Create a new run with an automatically generated run number ---------
     ...
     String parentMachine, int parentShot, int parentRun) throws UALException
 {
	...
	throw new UALException("Cannot create Catalogue Entry");
     return createEnv("imas", shot, run, shot, run, user, machine, dataVersion);
 }
 ...
 **/
/*
    public static Actuator getdb(String user, String machine, int shot, int run, String path, int occurrence) throws UALException
    {
 ...
 **/
/*
    public static Core_Profiles getdb(String user, String machine, int shot, int run, String path, int occurrence) throws UALException
    {
		int idx = UALLowLevel.openDb(user, machine, shot, run, path, occurrence);
		if (occurrence != 0)
			path = path + "/" + occurrence;
 ...
 **/
/*
    public static Equilibrium getdb(String user, String machine, int shot, int run, String path, int occurrence) throws UALException
    {
		int idx = UALLowLevel.openDb(user, machine, shot, run, path, occurrence);
		if (occurrence != 0)
			path = path + "/" + occurrence;
 ...
 **/
/*
    public static Magnetics getdb(String user, String machine, int shot, int run, String path, int occurrence) throws UALException
    {
		int idx = UALLowLevel.openDb(user, machine, shot, run, path, occurrence);
		if (occurrence != 0)
			path = path + "/" + occurrence;
 ...
 **/
/*
    public static PF getdb(String user, String machine, int shot, int run, String path, int occurrence) throws UALException
    {
		int idx = UALLowLevel.openDb(user, machine, shot, run, path, occurrence);
		if (occurrence != 0)
			path = path + "/" + occurrence;
 ...
 **/
/*
    public static SDN getdb(String user, String machine, int shot, int run, String path, int occurrence) throws UALException
    {
		int idx = UALLowLevel.openDb(user, machine, shot, run, path, occurrence);
		if (occurrence != 0)
			path = path + "/" + occurrence;
 ...
 **/
/*
    public static TF getdb(String user, String machine, int shot, int run, String path, int occurrence) throws UALException
    {
		int idx = UALLowLevel.openDb(user, machine, shot, run, path, occurrence);
		if (occurrence != 0)
			path = path + "/" + occurrence;
