 ...
 * @param srcIdx The index of the source database, returned by IDS.open()
 * @param srcOccur The occurence of the IDS in the source database.
 * @param destIdx The index of the destination database, returned by IDS.open()
 ...
 * @param expIdx The index to the database, returned by IDS.open()
 ...
 * @param interpolMode Defines the selected interpolation. Allowed values are IDS.INTERPOLATION, IDS.CLOSEST_SAMPLE,
 * IDS.PREVIOUS_SAMPLE
 * @exception UALException Issued when data cannot be accessed for any reason. Note that the exception is not raised if there are 
 * missing IDS fields. 
