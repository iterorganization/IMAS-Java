...
public class Vect3DComplex extends VectComplex
{
    int dim1;
    int dim2;
    int dim3;
    
    public Vect3DComplex(int dim1, int dim2, int dim3)
    {
        this.dim1 = dim1;
        this.dim2 = dim2;
        this.dim3 = dim3;
        array = new Complex[dim1*dim2*dim3];
    }
    public Vect3DComplex(int dim1, int dim2, int dim3, Complex array[])
    {
        this(dim1, dim2, dim3);
        this.array = array;
    }
    ...
    public int[] getDims() {int[] d={dim1,dim2,dim3}; return d;}
    public Vect2DComplex getElementAt(int i) 
    {
        Complex retArr[] = new Complex[dim1*dim2];
        System.arraycopy(array, i*dim1*dim2, retArr, 0, dim1*dim2);
        return new Vect2DComplex(dim1, dim2, retArr);
    }
    public void setElementAt(int i, Vect2DComplex element)
    {
        System.arraycopy(element.array, 0, array, i * dim1 * dim2, dim1*dim2);
    }
    public Complex getElementAt(int i, int j, int k) 
    {
    	return array[i+j*dim1+k*dim1*dim2];
    }
    public void setElementAt(int i, int j, int k, Complex element) 
    {
