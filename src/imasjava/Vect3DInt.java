...
public class Vect3DInt extends SummaryString
{
   ...
   public Vect2DInt getElementAt(int i) 
    ...
    public int getElementAt(int i, int j, int k) {return array[i+j*dim1+k*dim1*dim2];}
    public void setElementAt(int i, int j, int k, int element) {array[i+j*dim1+k*dim1*dim2] = element;}
    public int[] getArray() 
    {
        return array;
    }
