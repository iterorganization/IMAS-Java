...
public class Vect4DDouble extends SummaryString {
  ...
  public double getElementAt(int i, int j, int k, int h) {
    return array[i + j * dim1 + k * dim1 * dim2 + h * dim1 * dim2 * dim3];
  }

  public void setElementAt(int i, int j, int k, int h, double element) {
  ...
  public double[][][][] get() {
    ...
    double[][][][] array = new double[dim1][dim2][dim3][dim4];
