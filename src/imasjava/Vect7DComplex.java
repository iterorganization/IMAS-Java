...
public class Vect7DComplex extends VectComplex {
  ...
  public Vect7DComplex(
      int dim1, int dim2, int dim3, int dim4, int dim5, int dim6, int dim7, Complex array[]) {
  ...
  public Complex[][][][][][][] get() {
    ...
    Complex[][][][][][][] array = new Complex[dim1][dim2][dim3][dim4][dim5][dim6][dim7];
