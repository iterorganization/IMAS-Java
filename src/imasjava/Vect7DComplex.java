...
public class Vect7DComplex extends VectComplex
{
    int dim1;
    int dim2;
    int dim3;
    ...
    public Vect7DComplex(int dim1, int dim2, int dim3, int dim4, int dim5, int dim6,int dim7)
    {
        this.dim1 = dim1;
        this.dim2 = dim2;
        this.dim3 = dim3;
        ...
        this.dim6 = dim6;
        this.dim7 = dim7;
        array = new Complex[dim1*dim2*dim3*dim4*dim5*dim6*dim7];
    }
    public Vect7DComplex(int dim1, int dim2, int dim3, int dim4, int dim5, int dim6, int dim7, Complex array[])
    {
    ...
    public int[] getDims() {int[] d={dim1,dim2,dim3,dim4,dim5,dim6,dim7}; return d;}
    public Vect6DComplex getElementAt(int i) 
    {
	   Complex retArr[] = new Complex[dim1*dim2*dim3*dim4*dim5*dim6];
        System.arraycopy(array, i*dim1*dim2*dim3*dim4*dim5*dim6, retArr, 0, dim1*dim2*dim3*dim4*dim5*dim6);
        return new Vect6DComplex(dim1, dim2, dim3, dim4, dim5, dim6, retArr);
    }
    public void setElementAt(int i, Vect6DComplex element)
    {
        System.arraycopy(element.array, 0, array, i * dim1*dim2*dim3*dim4*dim5*dim7, dim1*dim2*dim3*dim4*dim5*dim6);
    }
    public Complex getElementAt(int i, int j, int k, int h, int l, int m, int n) 
    {
    ...
    public void setElementAt(int i, int j, int k, int h,int l, int m, int n, Complex element) 
    {
